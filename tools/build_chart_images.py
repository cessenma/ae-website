...
# Charts for pages that already rank — these carry real tables and real impressions
# but had no image for Images to return.
SPECS.update({
 "english-names-boys-chart": dict(page="english-names-boys", cols=3, width=1680, max_rows=84,
   title="男生英文名字對照表", sub="常用男生英文名 ・ 唸法提示與來源",
   alt="男生英文名字對照表：常用英文名的唸法提示與名字來源，附中文說明",
   foot="可儲存列印｜americanenglish.com.tw"),
 "english-names-girls-chart": dict(page="english-names-girls", cols=3, width=1680, max_rows=84,
   title="女生英文名字對照表", sub="常用女生英文名 ・ 唸法提示與來源",
   alt="女生英文名字對照表：常用英文名的唸法提示與名字來源，附中文說明",
   foot="可儲存列印｜americanenglish.com.tw"),
 "english-dates-chart": dict(page="english-dates-guide", width=1400,
   title="英文日期對照表", sub="1-31 日 ・ 序數寫法、縮寫與唸法",
   alt="英文日期對照表：1到31日的英文序數寫法、縮寫與唸法，含月份縮寫",
   foot="可儲存列印｜americanenglish.com.tw"),
 "english-vowels-consonants-chart": dict(page="english-vowels-consonants", width=1400,
 ...
 "english-symbol-names-chart": dict(page="english-symbol-names", cols=3, width=1680, max_rows=48,
   ...
   foot="可儲存列印｜americanenglish.com.tw"),
 "english-alphabet-chart": dict(page="english-alphabet-guide", width=1300,
   title="英文字母表", sub="26 個字母 ・ 大小寫、唸法與發音",
   alt="英文字母表：26個字母的大小寫、名稱唸法與字母音對照",
   foot="可儲存列印｜americanenglish.com.tw"),
 ...
 "happy-birthday-chart": dict(page="happy-birthday-english", cols=2, width=1500,
   ...
   alt="生日快樂英文祝福語對照表：生日卡片與訊息常用的英文說法與中文對照",
   foot="可儲存列印｜americanenglish.com.tw"),
 "mid-autumn-chart": dict(page="mid-autumn-festival-english", cols=2, width=1500,
   title="中秋節英文說法", sub="月餅、賞月、烤肉 ・ 中秋相關單字與句子",
   alt="中秋節英文對照表：月餅、賞月、烤肉、文旦等中秋節相關英文單字與句子",
   foot="可儲存列印｜americanenglish.com.tw"),
 "english-capitalization-chart": dict(page="english-capitalization-guide", width=1400,
   title="英文大寫規則表", sub="什麼時候要大寫 ・ 規則與例外",
   alt="英文大寫規則對照表：專有名詞、月份星期、標題等何時要大寫的規則與例句",
   foot="可儲存列印｜americanenglish.com.tw"),
 "be-verbs-chart": dict(page="be-verbs-guide", cols=2, width=1440,
 ...
 "a2-grammar-chart": dict(page="a2-grammar-guide", cols=2, width=1560, max_rows=54,
   title="A2 文法重點表", sub="劍橋 A2／KET 程度 ・ 時態、句型與常見用法",
   alt="A2英文文法重點對照表：劍橋A2與KET程度的時態、句型與用法整理",
   foot="可儲存列印｜americanenglish.com.tw"),
 "b1-grammar-chart": dict(page="b1-grammar-guide", cols=2, width=1560, max_rows=40,
   title="B1 文法重點表", sub="劍橋 B1／PET 程度 ・ 時態、被動與關係子句",
   alt="B1英文文法重點對照表：劍橋B1與PET程度的時態、被動語態與關係子句整理",
   foot="可儲存列印｜americanenglish.com.tw"),
 "b2-grammar-chart": dict(page="b2-grammar-guide", cols=3, width=1700, max_rows=48,
   title="B2 文法重點表", sub="劍橋 B2／FCE 程度 ・ 進階時態與句型",
   alt="B2英文文法重點對照表：劍橋B2與FCE程度的進階時態、句型與用法整理",
   foot="可儲存列印｜americanenglish.com.tw"),
 "prepositions-chart": dict(page="in-on-at-prepositions", cols=2, width=1500,
   title="in、on、at 用法對照表", sub="時間與地點 ・ 什麼時候用哪一個",
   alt="in on at 介系詞用法對照表：時間與地點的使用時機與例句整理",
   foot="可儲存列印｜americanenglish.com.tw"),
 "conjunctions-chart": dict(page="english-conjunctions-guide", width=1440,
   title="英文連接詞對照表", sub="and、but、because、although ・ 用法與例句",
   alt="英文連接詞對照表：and but because although 等連接詞的用法與例句",
   foot="可儲存列印｜americanenglish.com.tw"),
 "comparatives-chart": dict(page="english-comparatives-guide", width=1440,
   title="英文比較級最高級表", sub="-er／-est 與 more／most ・ 不規則變化",
   alt="英文比較級與最高級對照表：-er -est 與 more most 規則及不規則變化",
   foot="可儲存列印｜americanenglish.com.tw"),
 "punctuation-chart": dict(page="english-punctuation-guide", width=1440,
   title="英文標點符號表", sub="逗號、句號、引號 ・ 名稱與用法",
   alt="英文標點符號對照表：逗號句號引號等符號的英文名稱與正確用法",
   foot="可儲存列印｜americanenglish.com.tw"),
 "kk-vs-phonics-chart": dict(page="kk-phonetics-vs-phonics", width=1440,
