...
ROUTES = {
 ...
 "english-numbers-guide": ("數字會唸之後", "數字，<em>聽得出來嗎？</em>",
 ...
 "months-english": ("月份記熟之後", "日期和時間，<em>寫得對嗎？</em>",
   ...
   [("KET 寫作 Part 6 短訊息", "/ket-rw-practice-part6/"), ("星期英文對照表", "/days-of-week-english/"), ("主題字表總整理", "/english-vocabulary-by-topic/"), ("英文書信怎麼寫", "/english-letter-writing-guide/"),
    ("英文日期怎麼寫、怎麼唸", "/english-dates-guide/"), ("序數 1st–31st", "/ordinal-numbers-english/")]),
 "colors-english-vocabulary": ("顏色學完，下一步", "形容詞，<em>順序放對了嗎？</em>",
   "顏色是形容詞的一種，真正的考點是「好幾個形容詞排在一起時誰在前」。下面的文法頁把順序整理成一張表，練習題可以直接驗收。",
   [("A2 文法指南", "/a2-grammar-guide/"), ("主題字表總整理", "/english-vocabulary-by-topic/"), ("A2 單字情境練習", "/a2-vocabulary-practice/"), ("水果英文對照表", "/fruits-english-vocabulary/")]),
 "fruits-english-vocabulary": ("水果會說之後", "點餐和購物，<em>講得出來嗎？</em>",
 ...
 "days-of-week-english": ("星期記熟之後", "講行程，<em>時態對嗎？</em>",
   ...
   [("英文時態總表", "/english-tenses-chart/"), ("月份英文對照表", "/months-english/"), ("主題字表總整理", "/english-vocabulary-by-topic/"), ("A2 文法指南", "/a2-grammar-guide/"),
    ("英文日期怎麼寫、怎麼唸", "/english-dates-guide/")]),
 ...
 "kk-phonetic-chart": ("查完音標，下一步", "會看音標了，<em>聽得出來嗎？</em>",
   ...
   [("KET 聽力 Part 1 免費練習", "/ket-listening-practice-part1/"), ("Starters 聽力 看圖三選一", "/starters-listening-practice-part3/"),
    ...
    ("母音子音完整表", "/english-vowels-consonants/"), ("英文字母表（26 個唸法）", "/english-alphabet-guide/")]),
 "phonics-rules-chart": ("規則會了，下一步", "自然發音學完，<em>拼得出來嗎？</em>",
   ...
   [("Starters 排字母拼單字", "/starters-rw-practice-part3/"), ("Starters 題庫總覽", "/starters-practice-tests/"),
    ...
    ("英文字母表", "/english-alphabet-guide/"), ("母音子音完整表", "/english-vowels-consonants/")]),
 "moe-1200-words-guide": ("背完 1200 字之後", "這些字，<em>會用了嗎？</em>",
   ...
   [("KET 閱讀 Part 4 選字填空", "/ket-rw-practice-part4/"), ("主題字表總整理（可點聽）", "/english-vocabulary-by-topic/"),
    ("A2 單字情境練習（64 題）", "/a2-vocabulary-practice/"), ("KET 分數計算機", "/ket-score-calculator/"),
    ("顏色英文對照表", "/colors-english-vocabulary/"), ("動物英文單字", "/animals-english-vocabulary/"), ("英文數字 1-100", "/english-numbers-guide/")]),
 "irregular-verbs-list": ("三態背完，下一步", "動詞三態，<em>放進句子裡試試</em>",
   ...
   [("KET 閱讀 Part 5 開放填空", "/ket-rw-practice-part5/"), ("PET 閱讀 Part 6 開放式克漏字", "/pet-reading-practice-part6/"),
    ...
    ("be 動詞變化表", "/be-verbs-guide/"), ("比較級最高級", "/english-comparatives-guide/"), ("連接詞總整理", "/english-conjunctions-guide/")]),
 "happy-birthday-english": ("祝福寫完，下一步", "寫短訊息，<em>其實是考題</em>",
   ...
   [("KET 寫作 Part 6 短訊息", "/ket-rw-practice-part6/"), ("英文書信怎麼寫", "/english-letter-writing-guide/"),
    ...
    ("謝謝的 30 種說法", "/thank-you-english/"), ("中秋節英文", "/mid-autumn-festival-english/"), ("月份英文對照表", "/months-english/")]),
 ...
 "english-alphabet-guide": ("字母會了，下一步", "26 個字母之後，<em>開始拼字</em>",
   ...
   [("Starters 排字母拼單字", "/starters-rw-practice-part3/"), ("Starters 單字練習（36 題）", "/starters-vocabulary-practice/"),
    ...
    ("母音子音完整表", "/english-vowels-consonants/"), ("KK 音標表（可點聽）", "/kk-phonetic-chart/")]),
 ...
 "english-dates-guide": ("日期會說了，下一步", "聽力考日期，<em>就是這一題</em>",
   ...
   [("KET 聽力 Part 2 筆記填空", "/ket-listening-practice-part2/"), ("KET 題庫總覽（14 頁）", "/ket-practice-tests/"),
    ...
    ("月份英文 1-12 月對照表", "/months-english/"), ("星期英文對照表", "/days-of-week-english/"), ("序數 1st–31st", "/ordinal-numbers-english/")]),
 ...
 "cambridge-exam-registration-taiwan": ("報名前，先做題", "報名之前，<em>先確認程度對不對</em>",
   ...
   [("劍橋英檢題庫總表（80 頁）", "/cambridge-practice-tests/"), ("KET 題庫", "/ket-practice-tests/"),
    ...
    ("報名後練整份：完整模擬試卷", "/cambridge-practice-exam-pack/")]),
 "ket-vs-gept-comparison": ("比較完，做題看看", "兩張證書，<em>先用免費題目試一下</em>",
   ...
   [("KET 題庫（14 頁免費）", "/ket-practice-tests/"), ("全民英檢題庫／歷屆試題", "/gept-practice-tests/"),
    ...
    ("KET 完整模擬試卷（9 份）", "/cambridge-practice-exam-pack/")]),
 "cambridge-starters-guide": ("看完 Starters，動手做", "Starters 沒有及格線，<em>做一份就知道盾牌在哪</em>",
   "Starters 只有盾牌數，沒有及不及格；做一份免費的線上題目，看孩子哪一大題拿的盾最少，比再讀一篇介紹有用。想整份計時、像考場一樣做完的，完整模擬試卷也做好了。",
   [("Starters 題庫（免費）", "/starters-practice-tests/"), ("Movers 指南（下一級）", "/cambridge-movers-guide/"),
    ("劍橋英檢等級對照表", "/cambridge-english-levels/"), ("54 份完整模擬試卷", "/cambridge-practice-exam-pack/")]),
 "cambridge-movers-guide": ("看完 Movers，動手做", "A1 是四項一起上場，<em>先看哪一項最弱</em>",
   "Movers 開始四項都算盾牌——聽力、閱讀寫作、口說各自計盾。免費的線上題目一大題一大題做，最弱的那一項就是接下來要練的；整份計時做完，用完整模擬試卷。",
   [("Movers 題庫（免費）", "/movers-practice-tests/"), ("Flyers 指南（下一級）", "/cambridge-flyers-guide/"),
    ("劍橋英檢等級對照表", "/cambridge-english-levels/"), ("54 份完整模擬試卷", "/cambridge-practice-exam-pack/")]),
 "cambridge-flyers-guide": ("Flyers 之後", "Flyers 拿滿盾，<em>下一步就是 KET</em>",
   "Flyers 的題型已經是 KET 的縮小版：先用免費題目把 Flyers 各大題做順，再看 KET 指南決定什麼時候跨過去。整份計時的完整模擬試卷，Flyers 和 KET 都有。",
   [("Flyers 題庫（免費）", "/flyers-practice-tests/"), ("KET 指南（下一級）", "/ket-prep-guide/"),
    ("KET 題庫（免費）", "/ket-practice-tests/"), ("54 份完整模擬試卷", "/cambridge-practice-exam-pack/")]),
 "cambridge-exam-worth-it": ("值不值得，做題再說", "值不值得考，<em>做一份題目最快知道</em>",
   "文章能講的是制度；孩子做得順不順、哪一項會卡，要做過才知道。六個級別的線上題目都免費，做完輸入分數計算機看落在哪一段；覺得值得再拿整份計時做的完整模擬試卷。",
   [("劍橋英檢題庫總表", "/cambridge-practice-tests/"), ("KET 分數計算機", "/ket-score-calculator/"),
    ("KET vs 全民英檢", "/ket-vs-gept-comparison/"), ("54 份完整模擬試卷", "/cambridge-practice-exam-pack/")]),
 "mid-autumn-festival-english": ("中秋之外", "節慶祝福會說了，<em>其他場合呢？</em>",
   "中秋節的句子學會了，生日、道謝和日期是接下來最常用到的三塊——都有整理好的對照表，可以點著聽發音。",
   [("生日快樂英文", "/happy-birthday-english/"), ("謝謝的 30 種說法", "/thank-you-english/"),
    ("月份英文對照表", "/months-english/"), ("英文書信格式", "/english-letter-writing-guide/")]),
